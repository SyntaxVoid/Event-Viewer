## John Gresl 4/24/2018
# Added so that we can convert binary files as well as text files to the .npy file format
# Modified version of Orin's convert_reco_to_npy.py
